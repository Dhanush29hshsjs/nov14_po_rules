    ...
    function (MessageBox, MessageToast, UIComponent) {
        ...
        function _createUploadController(oExtensionAPI, Entity) {
            ...
            return {
                ...
                onOk: function (oEvent) {
                 debugger;
                    let inputString = oEvent.oSource.oPropagatedProperties.oModels.pageInternal.mContexts["/pages/supplier2nd::Invoice1ObjectPage/controls/fe::FormContainer::F1"].oModel.oData.currentCtxt.sPath;
        ...
        return {
            upload: function (oBindingContext, aSelectedContexts) {
                this.loadFragment({
                    ...
                    name: "pocockpitdep.ext.fragment.Draftattachment",
