...
annotate service.po_data_itemD with @(UI.LineItem #DraftItems: [
    {
        $Type: 'UI.DataField',
        Value: slno,
        Label: 'SL.NO',
...
annotate service.po_data_itemS with @(UI.LineItem #SubmittedItems: [
    {
        $Type: 'UI.DataField',
        Value: slno,
        Label: 'SL.NO',
...
annotate service.Newtab with @(UI.HeaderInfo: {
    TypeName      : ' ',
    TypeNamePlural: '',
    Title         : {
        $Type: 'UI.DataField',
...
annotate service.Draft with @(UI.HeaderInfo: {
    Title         : {
        $Type: 'UI.DataField',
        Value: Ref_PO_No,
    },
...
annotate service.Submitted with @(UI.HeaderInfo: {
    Title         : {
        $Type: 'UI.DataField',
        Value: Ref_PO_No,
    },
...
annotate service.Newtab with @(UI.SelectionPresentationVariant #tableView1: {
    $Type              : 'UI.SelectionPresentationVariantType',
    PresentationVariant: {
        $Type         : 'UI.PresentationVariantType',
        Visualizations: ['@UI.LineItem', ],
...
annotate service.Newtab with @(UI.SelectionPresentationVariant #tableView2: {
    $Type              : 'UI.SelectionPresentationVariantType',
    PresentationVariant: {
        $Type         : 'UI.PresentationVariantType',
        Visualizations: ['@UI.LineItem', ],
...
annotate service.Newtab with @(UI.Identification: []);
annotate service.Draft with @(UI.Identification: []);
annotate service.Submitted with @(UI.Identification: []);
/////////////////////////
